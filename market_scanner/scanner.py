...
class MarketScanner:
    ...
    def scan(
        ...
        *,
        ...
        if proposal_mode != "skip":
            ranked = self._add_top_candidate_proposals(ranked, scanned_at, proposal_mode)
    ...
    def _add_top_candidate_proposals(
        ...
        return [
            self._candidate_with_proposals(candidate, scanned_at, proposal_mode)
    ...
    def _candidate_with_proposals(
        ...
        if proposal_mode == "simulate":
            try:
                ...
                proposals, blocked = self._simulated_option_proposals(record, candidate.metrics, scanned_at)
            ...
            try:
                ...
                underlying = self.option_provider.last_underlying_price or candidate.metrics.current_price
