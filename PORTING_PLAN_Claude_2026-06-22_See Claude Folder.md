> ⚠️ **SUPERSEDED — do not edit this copy.** As of 2026-06-22 13:24 EST this plan is
> maintained ONLY at:
> `D:\Google Drive\0.000 Claude Code\Market Scanner Updates by Claude\PORTING_PLAN_Claude_2026-06-22.md`
> (that folder is the working folder for the new porting thread). This file is kept only for
> reference and may be deleted.
